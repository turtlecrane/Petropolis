...
public class DialogManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        // 쓰레기장 퀘스트
        talkData.Add(13000, new string[]{ "하아...어떻게 하지... :2",
            "겨우겨우 병원에 데려왔는데 치료도 못해주고 도망쳐버렸네... :0", 
            "지금쯤 다시 쓰레기장으로 돌아갔을라나...\n환경도 건강에 안좋을텐데 걱정된다.. :2", 
            "쓰레기장에 누가 있는걸까? 한번 들려봐야겠다 :10",
            "내가 직접 갈 수도 없고..어떻게 하지.. :102"});//첫 퀘스트 수주
        talkData.Add(13001, new string[]{ "앗 너도 떠돌아다니는 고양이니? \n 음...넌 생각보다 건강해보이는구나 잘가렴 :1"});//퀘스트 중일떄
        talkData.Add(13002, new string[]{ "아까 봤던 고양이네... :0",
            "앗! 도망친 고양이랑 함께 왔구나! :1",
            "내 혼잣말을 이해라도 한걸까... 아무튼 왔으니까 검진부터 해야겠다! :104"});//퀘스트 클리어 -> 고양이를 데리고 온 그 순간
        talkData.Add(13003, new string[]{ "꼬질꼬질한 고양이는 치료받고 쉬는 중이야 너 덕분에 건강해질거 같구나! :1"});//퀘스트 완료 후 대사
        
        talkData.Add(13010, new string[]{ "콜록콜록...이런 곳까지 오는 녀석이 있네 :0",
            "이 쓰레기장은 내 구역이다 잘못 들어왔다면 빨리 나가 :0",
            "좀 전에 병원에서 도망친 게 너니? 나랑 병원으로 돌아가자 :10",
            "콜록콜록...뭐? 날 납치한 인간한테 돌아가라고? 그게 말이 되는 소린거 같아? :0",
            "하지만 기침하는걸 보니까 내가 다 걱정되는걸 병원에 가면 분명 고칠 수 있을거야! :10",
            "흐음...요즘 여기저기 아프긴 한데..:0",
            "밑져야 본전인가...한번 따라가 보도록 하지... :103"});//꼬질이
