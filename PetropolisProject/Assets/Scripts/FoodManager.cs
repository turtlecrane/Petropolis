...
public class FoodManager : MonoBehaviour
{
    ...
    void FoodTextData()
    {
        ...
        foodData.Add(1004, new string[] { "맛있어보이는 수박이다. 먹을까?", "수박을 먹고 수분과 비타민을 보충했다!" });
        foodData.Add(1005, new string[] { "맛있어보이는 삶은 완두콩이다. 먹을까?", "삶은 완두콩을 먹고 영양분을 얻었다!" });
        foodData.Add(1006, new string[] { "맛있어보이는 호박이다. 먹을까?", "호박을 먹고 비타민, 섬유질, 칼슘을 보충했다!" });
        foodData.Add(1007, new string[] { "맛있어보이는 고양이용 연어통조림이다. 먹을까?", "연어통조림을 먹고 포만감을 얻었다!" });
        foodData.Add(1008, new string[] { "맛있어보이는 고양이용 참치통조림이다. 먹을까?", "참치통조림을 먹고 포만감을 얻었다!" });
        foodData.Add(1009, new string[] { "맛있어보이는 요거트다. 먹을까?", "요거트를 먹고 건강이 좋아졌다!" });
        foodData.Add(1010, new string[] { "맛있어보이는 버섯이다. 먹을까?", "버섯을 먹고 포만감을 얻었다!" });
