...
public class FoodManager : MonoBehaviour
{
    ...
    void FoodTextData()
    {
        ...
        foodData.Add(4002, new string[] { "맛있어보이는 와인이다. 먹을까?", "와인을 먹고 치명적인 알코올 중독에 걸려버렸다! 한시라도 빨리 병원에 가야해!"});
        foodData.Add(4003, new string[] { "맛있어보이는 포도다. 먹을까?", "포도을 먹고 치명적인 급성 신부전에 걸려버렸다! 한시라도 빨리 병원에 가야해!"});
        foodData.Add(4004, new string[] { "맛있어보이는 마늘이다. 먹을까?", "마늘을 먹고 치명적인 용혈성 빈혈에 걸려버렸다! 한시라도 빨리 병원에 가야해!"});
        foodData.Add(4005, new string[] { "맛있어보이는 양파다. 먹을까?", "양파을 먹고 치명적인 용혈성 빈혈에 걸려버렸다! 한시라도 빨리 병원에 가야해!"});
